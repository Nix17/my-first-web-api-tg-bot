...
public static class MetadataExtensions
{
    ...
    public static string GetDescription<TModel, TProperty>(this TModel model, Expression<Func<TModel, TProperty>> expression)
    {
        ...
        attr = (DescriptionAttribute)type.GetProperty(propertyName).GetCustomAttributes(typeof(DescriptionAttribute), true).SingleOrDefault();
        ...
        if (attr == null)
        {
            ...
            if (metadataType != null)
            {
                ...
                if (property != null)
                {
                    attr = (DescriptionAttribute)property.GetCustomAttributes(typeof(DescriptionAttribute), true).SingleOrDefault();
                }
            }
        }
        return (attr != null) ? attr.Description : String.Empty;
    }
    public static string GetDisplayNameAttr<TModel, TProperty>(this TModel model, Expression<Func<TModel, TProperty>> expression)
    {
